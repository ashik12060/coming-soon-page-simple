...
//we have to export a default value. There was no default keyword. So I put the value here
export default function Counter() {
  ...
  useEffect(() => {
    ...
    let clockInterval = setInterval(() => {
      ...
      /* 
      there were negative value for date. It happens because the given hardcoded date was from 
      the previous year. So, I fixed the value of the date.
      */
